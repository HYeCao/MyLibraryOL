        ...
        function setDeposit() {
            ...
            if (deposit == "") {
                ...
                if (deposit1!= deposit) {
                    ...
                    if (deposit <= 0) {
                        alert("The deposit Should be greater than 0")
                    } else {
                        window.location = 'adminaction.php?action=setDeposit&deposit=' + deposit;
                    }
                }
            }
        }
...
<div id="content2-2" style="height:550px;width:82%; float:left;">
    ...
    <form>
        <table border="1" align="center">
            <tr>
                <td width="200px" height="40px" style="font-size:20px">set deposit</td>
                <td width="300px" height="40px" style="font-size:20px">
                    <input type="number" id="deposit" style="height:35px;width:300px;" placeholder="please input the new deposit for the reader "></td>
            </tr>
            <tr>
                <td align="center" width="200px" height="40px">
                    <input type="button" style="BACKGROUND-COLOR: rgba(255,255,255,0.2);border:1px;
                height:35px;width:70px; font-size:15px;" value="OK" align="center"  onclick="setDeposit()"
                           onmouseover="this.style.backgroundColor='#2894FF';this.style.color='#FFFFFF';"
