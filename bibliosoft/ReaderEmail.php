...
<script>
    function email() {
        var id=(document.getElementById("email_name")).value;
        var test1= (document.getElementById("email_1")).value;
        var test2= (document.getElementById("email_2")).value;
        // alert(id+test1);
        if(id==""||test1==""||test2==""){
            alert("Please enter full information")
        }else{
            if(test1==test2){
                window.location='ReaderEmailAction.php?action=email&id='+id +'&email='+test1;
            }else {
                alert("Two Email are different")
            }
        }
    }
</script>
    ...
    <table border="1" align="center">
        <tr>
            ...
            <td width="300px" height="40px" style="font-size:20px">
                <input type="text" id="email_name" style="height:35px;width:300px;"></td>
        </tr>
        <tr>
            <td width="200px" height="40px" style="font-size:20px">New E-mail</td>
            <td width="300px" height="40px" style="font-size:20px">
                <input type="email" id="email_1" style="height:35px;width:300px;"></td>
        </tr>
        <tr>
            <td width="200px" height="40px" style="font-size:20px">Confirm E-mail</td>
            <td width="300px" height="40px" style="font-size:20px">
                <input type="email" id="email_2" style="height:35px;width:300px;"></td>
        </tr>
        <tr>
            <td align="center" width="200px" height="40px">
                <input type="button" style="BACKGROUND-COLOR: rgba(255,255,255,0.2);border:1px;
                height:35px;width:70px; font-size:15px;" value="OK" align="center"  onclick="email()"
