...
<div class="box">
    <div class="search_box">
        <form class="search_from" action="ReaderAppoint_do.php?act=seek" method="post">
            <span>
                <input class="search_input" type="text" name="bookName" placeholder="please input the name of book that you want to appoint ">
