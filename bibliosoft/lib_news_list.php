...
<table  style="width:1400px;height:35px" border="1">
    ...
    $sqli="select * from news_table limit $page,$pagesize";
    ...
    while($row = mysqli_fetch_array($result))
    {
        ...
        echo "<td><a href='lib_news_revise.php?id=$id'>Revise</a> ";?>
        <a href="lib_news_delete.php?id=<?php echo($id)?>" onclick="return delete();">Delete</a>
        <?php echo"</td>";
        echo "</tr>";
    }
    echo "</thead>";
