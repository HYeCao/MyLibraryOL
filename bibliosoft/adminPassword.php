...
<head>
    ...
    <script>
        function password() {
            var id=(document.getElementById("pw_name")).value;
            var test= (document.getElementById("opw")).value;
            var test1= (document.getElementById("pw_1")).value;
            var test2= (document.getElementById("pw_2")).value;
            // alert(id+test1);
            if(id==""||test1==""||test2==""||test==""){
                alert("Please enter full information")
            }else{
                if(test1==test2){
                    window.location='adminaction.php?action=password&id='+id +'&pw='+test1+'&opw='+test;
                }else {
...
<div id="content2-2" style="height:550px;width:82%; float:left;">
    ...
    <form>
        <table border="1" align="center">
            <tr>
                <td width="200px" height="40px" style="font-size:20px">adminname</td>
                <td width="300px" height="40px" style="font-size:20px">
                    <input type="text" id="pw_name" style="height:35px;width:300px;"></td>
            </tr>
            <tr>
                <td width="200px" height="40px" style="font-size:20px"> original password</td>
                <td width="300px" height="40px" style="font-size:20px">
                    <input type="password" id="opw" style="height:35px;width:300px;"></td>
            </tr>
            <tr>
                <td width="200px" height="40px" style="font-size:20px">new password</td>
                <td width="300px" height="40px" style="font-size:20px">
                    <input type="password" id="pw_1" style="height:35px;width:300px;"></td>
            </tr>
            <tr>
                <td width="200px" height="40px" style="font-size:20px">confirm password</td>
                <td width="300px" height="40px" style="font-size:20px">
                    <input type="password" id="pw_2" style="height:35px;width:300px;"></td>
            </tr>
            <tr>
