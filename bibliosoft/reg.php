...
<form action="register_do.php" method="POST" >
   ...
   <h3>登录密码(Password)：</h3>
    <input type="password" name="password" size="60"required="required"maxlength="25">
    <br>

   <h3>确认密码(Confirm Password)：</h3>
    <input type="password" name="confirmPassword" size="60"required="required" maxlength="25">
    <br>
