...
<body class="bg">
<p><strong>To get your password back,please input your adminName and e-mail：</strong></p>
    ...
    <div class="loginBox">
        <div class="loginBoxCenter">
            <div class="header">
                ...
                <hr />
                <form action="LibrarianSendMail.php" method="post">

                <p><label for="text">Username：</label></p>
                <p><input type="text" id="username" name="adminName" class="loginInput" autofocus="autofocus" required="required" autocomplete="off" placeholder="please input UserName" value="" /></p>
