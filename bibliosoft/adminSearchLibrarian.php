...
<head>
    ...
    <script>
    function sub(){
        var id = (document.getElementById("librarian_id")).value;
        var name = (document.getElementById("librarian_name")).value;
        if(id==""&&name==""){
            alert("Please enter any one of the inputs")
        }else{
...
<div id="content2-2" style="height:550px;width:82%; float:left;">
    <p></p>
    <form >
        <p align="center"style="font-size:20px"> Please enter any information about the librarian</p>
        <table border="1" align="center">
            <tr>
                <td width="200px" height="40px" style="font-size:20px">librarianId</td>
                <td width="300px" height="40px" style="font-size:20px">
                    <input type="text" id="librarian_id" style="height:35px;width:300px;"></td>
            </tr>
            <tr>
                <td width="200px" height="40px" style="font-size:20px">librarianName</td>
                <td width="300px" height="40px" style="font-size:20px">
                    <input type="text" id="librarian_name" style="height:35px;width:300px;"></td>
            </tr>
            <tr>
                <td align="center" width="200px" height="40px">
                    <input type="button" style="BACKGROUND-COLOR: rgba(255,255,255,0.2);border:1px;
                height:35px;width:70px; font-size:15px;" value="OK" align="center" onclick="sub()"
                           onmouseover="this.style.backgroundColor='#2894FF';this.style.color='#FFFFFF';"
