...
<body>
            ...
            <form action="lib_edit_search.php" method="get">
                <input type="text" name="id" placeholder="BookName">
	...
	<table  style="width:1400px;height:35px" border="1px">
            ...
            $sqli="select * from bookinfor limit $page,$pagesize";
        ...
        <div>
            <form action="lib_deleteHistory.php?act=admin" method="post">
                <button class="login" type="submit" style="height:40px;width:100px;float: left">DeleteHistory</button>
            </form>
        </div>
</body>
</html>