...
<div id="content2-2" style="height:350px;width:82%; float:left;">
    ...
    <form >
        <table border="1" align="center">
            ...
            $sql = "SELECT * from admin_table where permission='1'order by adminID desc limit $start,$pagesize";
...
<div id="content2-5" style="height:42px;width:82%; float:left;">
    <table  align="center">
        <td>
...
<div id="content2-3" style="height:100px;width:82%; float:left;">
    <table  align="center">
        <td>
            <a  href="<?php echo $_SERVER['PHP_SELF'].'?page='.'1'; ?>">
                <button style="BACKGROUND-COLOR: rgba(255,255,255,0.2);border:1px;
                height:35px;width:120px; font-size:15px;" value="OK" align="center"
                        onmouseover="this.style.backgroundColor='#2894FF';this.style.color='#FFFFFF';"
                        onmouseout="this.style.backgroundColor='';this.style.color='#000000';" >Home page</button>
            </a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a  href="adminShowLibrarian.php?page=<?php echo $prepage ?>">
             <button style="BACKGROUND-COLOR: rgba(255,255,255,0.2);border:1px;
                height:35px;width:120px; font-size:15px;" value="OK" align="center"
                     onmouseover="this.style.backgroundColor='#2894FF';this.style.color='#FFFFFF';"
                     onmouseout="this.style.backgroundColor='';this.style.color='#000000';">Previous page </button>
             </a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="<?php echo $_SERVER['PHP_SELF'].'?page='.$nextpage; ?>">
            <button style="BACKGROUND-COLOR: rgba(255,255,255,0.2);border:1px;
                height:35px;width:120px; font-size:15px;" value="OK" align="center"
                    onmouseover="this.style.backgroundColor='#2894FF';this.style.color='#FFFFFF';"
                    onmouseout="this.style.backgroundColor='';this.style.color='#000000';">Next page</button>
                 </a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="<?php echo $_SERVER['PHP_SELF'].'?page='.$pages; ?>">
                <button style="BACKGROUND-COLOR: rgba(255,255,255,0.2);border:1px;
                height:35px;width:120px; font-size:15px;" value="OK" align="center"
                        onmouseover="this.style.backgroundColor='#2894FF';this.style.color='#FFFFFF';"
                        onmouseout="this.style.backgroundColor='';this.style.color='#000000';">Last page</button>
            </a>
        </td>
        </table>
</div>
