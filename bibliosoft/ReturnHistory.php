...
<div>
    <form class="search_from" action="ReturnNewHistory.php?act=seek" method="get">
            <span>
...
<table  style="width:1400px;height:35px" border="1">
    ...
    $sqli="select * from `returninfor`,`bookinfor`,`reader_table`  where returninfor.bookID=bookinfor.bookID and reader_table.readername='$name'and returninfor.readerID=reader_table.readerID limit $page,$pagesize";
